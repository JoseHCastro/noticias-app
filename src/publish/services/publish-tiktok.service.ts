    ...
    try {
      ...
      const payload = {
        post_info: {
          ...
          privacy_level: 'SELF_ONLY', // SELF_ONLY para cuentas privadas con DIRECT_POST
        ...
        post_mode: 'DIRECT_POST', // Publica automáticamente (requiere cuenta privada como Target User)
        media_type: 'PHOTO',
      };
